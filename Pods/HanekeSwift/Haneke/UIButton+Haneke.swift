...
public extension UIButton {
    ...
    func hnk_shouldCancelImageForKey(_ key:String) -> Bool {
        ...
        Log.debug(message: <#String#>, "Cancelled set image for \((key as NSString).lastPathComponent)")
        return true
    }
    ...
    func hnk_shouldCancelBackgroundImageForKey(_ key: String) -> Bool {
        ...
        Log.debug(message: <#String#>, "Cancelled set background image for \((key as NSString).lastPathComponent)")
        return true
    }
}
