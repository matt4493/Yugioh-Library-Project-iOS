...
class Forbidden: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        cards = [
            // Effect monsters:
            ["Apoqliphort Towers", "Effect"],
            ["Blaster, Dragon Ruler of Infernos", "Effect"],
            ["Chaos Emperor Dragon  Envoy of the End", "Effect"],
            ["Cyber Jar", "Effect"],
            ["Cyber Stein", "Effect"],
            ["Destiny HERO   Disk Commander", "Effect"],
            ["Djinn Releaser of Rituals", "Effect"],
            ["Elemental HERO Stratos", "Effect"],
            ["Fiber Jar", "Effect"],
            ["Fishborg Blaster", "Effect"],
            ["Magical Scientist", "Effect"],
            ["Makyura the Destructor", "Effect"],
            ["Mind Master", "Effect"],
            ["Morphing Jar", "Effect"],
            ["Morphing Jar #2", "Effect"],
            ["Performage Damage Juggler", "Effect"],
            ["Performage Plushfire", "Effect"],
            ["Redox, Dragon Ruler of Boulders", "Effect"],
            ["Rescue Cat", "Effect"],
            ["Sangan", "Effect"],
            ["Shurit, Strategist of the Nekroz", "Effect"],
            ["Substitoad", "Effect"],
            ["Tempest, Dragon Ruler of Storms", "Effect"],
            ["Tidal, Dragon Ruler of Waterfalls", "Effect"],
            ["Tribe Infecting Virus", "Effect"],
            ["Victory Dragon", "Effect"],
            ["Witch of the Black Forest", "Effect"],
            ["Yata Garasu", "Effect"],
            
            // Fusion monsters:
            ["El Shaddoll Construct", "Fusion"],
            
            // Synchro Monsters:
            ["Brionac, Dragon of the Ice Barrier", "Synchro"],
            
            // Xyz monsters:
            ["Evilswarm Exciton Knight", "Xyz"],
            ["Lavalval Chain", "Xyz"],
            ["Number 16: Shock Master", "Xyz"],
            ["Tellarknight Ptolemaeus", "Xyz"],
            ["Wind Up Carrier Zenmaity", "Xyz"],
            
            // Spell cards:
            ["Brain Control", "Spell Card"],
            ["Butterfly Dagger  Elma", "Spell Card"],
            ["Card Destruction", "Spell Card"],
            ["Card of Safe Return", "Spell Card"],
            ["Change of Heart", "Spell Card"],
            ["Chicken Game", "Spell Card"],
            ["Cold Wave", "Spell Card"],
            ["Confiscation", "Spell Card"],
            ["Delinquent Duo", "Spell Card"],
            ["Dimension Fusion", "Spell Card"],
            ["Future Fusion", "Spell Card"],
            ["Gateway of the Six", "Spell Card"],
            ["Giant Trunade", "Spell Card"],
            ["Graceful Charity", "Spell Card"],
            ["Harpie's Feather Duster", "Spell Card"],
            ["Heavy Storm", "Spell Card"],
            ["Last Will", "Spell Card"],
            ["Mass Driver", "Spell Card"],
            ["Metamorphosis", "Spell Card"],
            ["Mirage of Nightmare", "Spell Card"],
            ["Monster Reborn", "Spell Card"],
            ["Painful Choice", "Spell Card"],
            ["Pot of Avarice", "Spell Card"],
            ["Pot of Greed", "Spell Card"],
            ["Premature Burial", "Spell Card"],
            ["Snatch Steal", "Spell Card"],
            ["Spellbook of Judgment", "Spell Card"],
            ["Super Polymerization", "Spell Card"],
            ["Super Rejuvenation", "Spell Card"],
            ["The Forceful Sentry", "Spell Card"],
            ["Wavering Eyes", "Spell Card"],
            
            // Trap cards:
            ["Imperial Order", "Trap Card"],
            ["Last Turn", "Trap Card"],
            ["Return from the Different Dimension", "Trap Card"],
            ["Royal Oppression", "Trap Card"],
            ["Self Destruct Button", "Trap Card"],
            ["Sixth Sense", "Trap Card"],
            ["Solemn Judgment", "Trap Card"],
            ["Time Seal", "Trap Card"],
            ["Trap Dustshoot", "Trap Card"],
    ...
    override func tableView(_ tableView: UITableView!, didSelectRowAt indexPath: IndexPath) {
     ...
     override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell:CardInfo_Cell_aboutBanlist = tableView.dequeueReusableCell(withIdentifier: "forbiddenCell") as! CardInfo_Cell_aboutBanlist
        // Configure the cell...
