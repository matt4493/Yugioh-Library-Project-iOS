...
class SemiLimited: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        cards = [
            // Effect monsters:
            ["Atlantean Dragoons", "Effect"],
            ["Card Trooper", "Effect"],
            ["Cir, Malebranche of the Burning Abyss", "Effect"],
            ["Debris Dragon", "Effect"],
            ["Honest", "Effect"],
            ["Necroface", "Effect"],
            ["Summoner Monk", "Effect"],
            
            // Spell cards:
            ["Allure of Darkness", "Spell Card"],
            ["Chain Strike", "Spell Card"],
            ["Charge of the Light Brigade", "Spell Card"],
            ["Dark Hole", "Spell Card"],
            ["Dragon Ravine", "Spell Card"],
            ["Emergency Teleport", "Spell Card"],
            
            // Trap cards
            ["Ceasefire", "Trap Card"],
            ["Ojama Trio", "Trap Card"]
        ]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell:CardInfo_Cell_aboutBanlist = tableView.dequeueReusableCell(withIdentifier: "semiCell") as! CardInfo_Cell_aboutBanlist
        // Configure the cell...
