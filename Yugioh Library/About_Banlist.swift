...
class About_Banlist: UIViewController, UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        cards  = [
            ...
            // Spell cards:
            ["Advanced Ritual Art", "Spell Card"],
            
            // Trap cards:
            ["Crush Card Virus", "Trap Card"],
        ]
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        print("Cell Test 1")
        let cell:CardInfo_Cell_aboutBanlist = tableView.dequeueReusableCell(withIdentifier: "noLongerCell") as! CardInfo_Cell_aboutBanlist
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        print("Row Selected: \(indexPath.row) ::: Card Name: \(card_name)")
